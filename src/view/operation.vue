<style lang="less">
  .operation{
    ...
    .left1-content1-chart{
      width: 100%;
      height: 120px;
    }
    .left1-content1-footer{
      width: 100%;
      height: 50px;
      .elements{
        float: left;
  ...
  <div class="con" @click="flag===true ? start() : pause()">
    ...
    <head-title :headTip="headTip">
      ...
      <div class="operation main">
        ...
        <div class="contents">
          <div class="left">
            <div class="left1-contents1">
              <div class="left1-content1">
            ...
            <div class="left1-contents1 border-left">
              <div class="left1-content1">
                <div class="left1-content1-head">
                ...
                <div class="left1-content1-footer">
                  <div class="elements">
                    ...
                    <span class="text_color_1 font-size-12">择期:1,834</span>
                  </div>
                  <div class="elements">
                    <div class="element1 color_5"></div>
                    <span class="text_color_1 font-size-12">急诊:255</span>
                  </div>
                  <div class="elements">
                    <div class="element1 color_10"></div>
                    <span class="text_color_1 font-size-12">二进宫:8</span>
                  </div>
                  <div class="elements">
                    <div class="element1 color_8"></div>
                    <span class="text_color_1 font-size-12">门诊:50</span>
                  </div>
                </div>
              </div>
              <div class="left1-content2">
              ...
              <div class="left1-content2">
                ...
                <div class="left1-content2-line color_17">
                  ...
                  <span class="span2">1,490</span>
                </div>
                <div class="left1-content2-line color_18">
                  <span class="span1">4级</span>
                  <span class="span2">269</span>
                </div>
                <div class="left1-content2-line color_17">
                  <span class="span1">3级</span>
                  <span class="span2">775</span>
                </div>
                <div class="left1-content2-line color_18">
                  <span class="span1">2级</span>
                  <span class="span2">369</span>
                </div>
                <div class="left1-content2-line color_17">
            ...
            <div class="left1-contents2">
              <div class="left1-contents2-title">麻醉方式</div>
              <div class="left1-contents2-title">手术感染</div>
